...
const DEFAULT_GLOW_COLOR = '132, 0, 255'; // We can change this to a brand color if needed, like white or green, let's keep default or use white for now to match portfolio: '255, 255, 255'
              ...
              {item.tech && item.tech.length > 0 && (
                <div className="flex flex-wrap gap-2 md:gap-3 mt-auto">
                  {item.tech.map((tech, i) => (
                    <span key={i} className="text-[10px] md:text-xs text-white tracking-widest uppercase border border-[#1C1C1C] px-3 py-1.5 md:px-4 md:py-2 rounded-full bg-[#1C1C1C]/50">
                      {tech}
                    </span>
                  ))}
                </div>
