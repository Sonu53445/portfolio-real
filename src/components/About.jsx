...
const About = () => {
  ...
  return (
    <section id="about" ref={containerRef} className="py-16 md:py-28 px-6 md:px-12 max-w-7xl mx-auto z-10 relative">
      <div className="flex flex-col md:flex-row gap-8 md:gap-20">
        ...
        <div className="flex flex-col gap-8 md:gap-12 w-full lg:w-[55%] xl:w-[60%]">
          <p className="about-text text-2xl md:text-4xl lg:text-5xl font-light leading-[1.2] text-white cursor-default" style={{ textShadow: '0 2px 10px rgba(0,0,0,0.8)' }}>
            <VariableProximity
          ...
          <p className="about-text text-lg md:text-2xl font-light leading-[1.7] text-[#E8D8A8]" style={{ textShadow: '0 2px 15px rgba(0,0,0,1)' }}>
