    ...
    <section id="about" ref={containerRef} className="py-20 md:py-28 px-6 md:px-12 max-w-7xl mx-auto z-10 relative">
      <div className="flex flex-col md:flex-row gap-8 md:gap-20">
        ...
        <div className="flex flex-col gap-8 md:gap-12 max-w-4xl">
          <p className="about-text text-2xl md:text-4xl lg:text-5xl font-light leading-[1.2] text-white cursor-default" style={{ textShadow: '0 2px 10px rgba(0,0,0,0.5)' }}>
            <VariableProximity
          ...
          <p className="about-text text-lg md:text-2xl text-[#A1A1AA] font-light leading-[1.4]" style={{ textShadow: '0 2px 8px rgba(0,0,0,0.5)' }}>
